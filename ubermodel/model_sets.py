...
def get_model_set(model_set):
    ...
    model_sets = {
        "Added variables": ['S_lin', 'ST_lin', 'STH_km27', 'STH_km243',
                            'STHL_km27', 'STHW_km27', 'STHR_km27',
                            'STHL_km243', 'STHW_km243', 'STHR_km243'],

        "Increasing articulation": ['S_lin', 'ST_lin', 'STH_km27', 'STH_km243',
                                    'STH_km729', 'STH_km2187'],
        ...
        "Lagged LWdown": base_models + ['STHL_km243'] + [f % 'L' for f in lag_fmts],
